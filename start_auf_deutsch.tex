\chapter{Start auf Deutsch}\label{chapter:start_auf_deutsch}
    ...
    \subsection{Land}\label{subsection:deutsch:land}
        ...
        \scriptsize
        \begin{longtabu}to \textwidth {X[1.7,m] | X[3,m] | X[1.6,m] X[1.6,m] X[1.6,m] | X[1.1,m]}
            \multirow{2}{*}{\textbf{Land}} & \multirow{2}{*}{\textbf{Sprache}} & \multicolumn{3}{c|}{\textbf{Nationalität}} & \multirow{2}{*}{\textbf{Adjektiv}} \\ 
             & & \textsb{Maskulinum (der)} & \textsb{Femininum (die)} & \textsb{Plural (die)} &\\ \tabucline-
                \phonetics{Ägypten}{é-gu-ptan}{Egipto} & \phonetics{Arabisch}{à-rra-bix}{árabe} & \phonetics{Ägypter}{é-gu-pta}{egípcio} & \phonetics{Ägypterin}{é-gu-pta-rrin}{egípcia} & \phonetics{Ägypter}{é-gu-pta}{egípcio} & \phonetics{ägyptisch}{é-gu-ptix}{egípcio}\\ \hline
                \phonetics{Algerien}{àl-gê-rrian}{Argélia} & \phonetics{Arabisch}{à-rra-bix}{árabe} & \phonetics{Algerier}{àl-gê-rria}{argelino} & \phonetics{Algerierin}{àl-gê-rriarrin}{argelina} & \phonetics{Algerier}{àl-gê-rria}{argelinos} & \phonetics{algerisch}{àl-gê-rrix}{argelino} \\ \hline
                \phonetics{China}{xi-ná}{China} & \phonetics{Chinesisch}{xi-nê-zix}{chinês} & \phonetics{Chinese}{xi-nê-ze}{chinês} & \phonetics{Chinesin}{xi-nê-zin}{chinesa} & \phonetics{Chinesen}{xi-nê-zan}{chineses} & \phonetics{chinesisch}{xi-nê-zix}{chinês} \\ \hline
                \phonetics{Deutschland}{dói-tx-llãnd}{Alemanha} & \phonetics{Deutsch}{dói-tx}{alemão} & \phonetics{Deutsche}{dói-txa}{alemão} & \phonetics{Deutsche}{dói-txa}{alemã} & \phonetics{Deutschen}{dói-txan}{alemães} & \phonetics{deutsch}{dói-tx}{alemão} \\ \hline
                \phonetics{Frankreich}{frran-crraix}{França} & \phonetics{Französisch}{frran-ssö-zix}{francês} & \phonetics{Franzose}{frran-ssou-za}{francês} & \phonetics{Französin}{frran-ssö-zin}{francesa} & \phonetics{Franzosen}{frran-ssou-zan}{franceses} & \phonetics{französisch}{frran-ssö-zix}{francês} \\ \hline
                \phonetics{Großbritannien}{gross-brritanian}{Grã-Bretanha} & \phonetics{Englisch}{ên-glix}{inglês} & \phonetics{Brite}{brri-ta}{britânico} & \phonetics{Britin}{brri-tin}{britânica} & \phonetics{Briten}{brri-tan}{britânicos} & \phonetics{britisch}{brri-tix}{britânico} \\ \hline
                \phonetics{Italien}{itá-lian}{Itália} & \phonetics{Italienisch}{itá-liê-nix}{italiano} & \phonetics{Italiener}{itá-lia-ná}{italiano} & \phonetics{Italienerin}{itá-lia-na-rrim}{italiana} & \phonetics{Italiener}{itá-lia-ná}{italianos} & \phonetics{italienisch}{itá-liê-nix}{italiano} \\ \hline
                \phonetics{Japan}{iá-pan}{Japão} & \phonetics{Japanisch}{iá-pá-nix}{japonês} & \phonetics{Japaner}{iá-pá-na}{japonês} & \phonetics{Japanerin}{iá-pá-na-rrin}{japonesa} & \phonetics{Japaner}{iá-pá-na}{japoneses} & \phonetics{japanisch}{iá-pá-nix}{japonês} \\ \hline
                der \phonetics{Libanon}{li-bá-nón}{Líbano} & \phonetics{Arabisch}{à-rra-bix}{árabe} & \phonetics{Libanese}{li-bá-ni-za}{libanês} & \phonetics{Libanesin}{li-bá-ni-zin}{libanesa} & \phonetics{Libanesen}{li-bá-ni-zan}{libaneses} & \phonetics{libanesisch}{libá-ni-zix}{libanês} \\ \hline
                \phonetics{Österreich}{ös-ta-rraix}{Áustria} & \phonetics{Deutsch}{dói-tx}{alemão} & \phonetics{Österreicher}{ös-ta-rrai-xa}{austríaco} & \phonetics{Österreicherin}{ös-ta-rrai-xa-rrin}{austríaca} & \phonetics{Österreicher}{ös-ta-rrai-xa}{austríacos} & \phonetics{österreichisch}{ös-ta-rrai-xich}{austríaco} \\ \hline
                \phonetics{Polen}{pou-lan}{Polónia} & \phonetics{Polnisch}{póll-nix}{polaco} & \phonetics{Pole}{pou-la}{polaco} & \phonetics{Polin}{pou-lin}{polaca} & \phonetics{Polen}{pou-lan}{polacos} & \phonetics{polnisch}{póll-nix}{polaco} \\ \hline
                \phonetics{Portugal}{pórr-tu-gall}{Portugal} & \phonetics{Portugiesisch}{pórr-tu-gui-zix}{português} & \phonetics{Portugiese}{pórr-tu-gui-za}{português} & \phonetics{Portugiesin}{pórr-tu-gui-zin}{portuguesa} & \phonetics{Portugiesen}{pórr-tu-gui-zan}{portugueses} & \phonetics{portugiesisch}{pórr-tu-gui-zix}{português} \\ \hline
                \phonetics{Russland}{russ-lland}{Rússia} & \phonetics{Russisch}{ru-ssix}{russo} & \phonetics{Russe}{ru-sse}{russo} & \phonetics{Russin}{ru-ssin}{russa} & \phonetics{Russen}{ru-ssan}{russos} & \phonetics{russisch}{ru-ssix}{russo} \\ \hline
                die \phonetics{Schweiz}{xevai-tz}{Suíça} & \phonetics{Rätoromanisch}{ré-tou-rrou-má-nix}{} & \phonetics{Schweizer}{xevai-tza}{suíço} & \phonetics{Schweizerin}{xevai-tza-rrin}{suíça} & \phonetics{Schweizer}{xevai-tza}{suíços} & \phonetics{schweizerisch}{xevai-tza-rrix}{suíço} \\ \hline
                \phonetics{Spanien}{xpá-nian}{Espanha} & \phonetics{Spanisch}{xpá-nix}{espanhol} & \phonetics{Spanier}{xpá-nia}{espanhol} & \phonetics{Spanierin}{xpá-nia-rrin}{espanhola} & \phonetics{Spanier}{xpá-nia}{espanhóis} & \phonetics{spanisch}{xpá-nix}{espanhol} \\ \hline
                die \phonetics{Türkei}{türr-cai}{Turquia} & \phonetics{Türkisch}{tür-quix}{turco} & \phonetics{Türke}{tür-ca}{turco} & \phonetics{Türkin}{tür-quin}{turca} & \phonetics{Türken}{tür-can}{turcos} & \phonetics{türkisch}{tür-quix}{turco} \\ \hline
                die \phonetics{USA}{}{USA} & \phonetics{Englisch}{ên-glix}{inglês} & \phonetics{Amerikaner}{à-mé-rri-ca-na}{americano} & \phonetics{Amerikanerin}{à-mé-rri-ca-na-rrin}{americana} & \phonetics{Amerikaner}{à-mé-rri-ca-na}{americanos} & \phonetics{amerikanisch}{à-mé-rri-ca-nix}{americano} \\ \hline
        \end{longtabu}
        \normalsize
    ...
    \subsection{Verbale Konjugationen \textit{(Conjugações verbais)}}\label{section:verbalekonjugationen}

        \subsubsection{Regular}

            \begin{longtabu}to \textwidth {X[1.2,r] X[6,m] X[6,m] X[6,m]}
                \toprule
                & \textbf{heißen} \textit{chamar-se} & \textbf{wohnen} \textit{morar} & \textbf{kommen} \textit{vir (natural de)}\\ \tabucline-
                    ich & \textsb{heiß}\textit{e} & \textsb{wohn}\textit{e} & \textsb{komm}\textit{e}\\ \hline
                    du & \textsb{heiß}\textit{t} & \textsb{wohn}\textit{st} & \textsb{komm}\textit{st}\\ \hline
                    er/sie & \textsb{heiß}\textit{t} & \textsb{wohn}\textit{t} & \textsb{komm}\textit{t}\\ \hline
                    Sie & \textsb{heiß}\textit{en} & \textsb{wohn}\textit{en} & \textsb{komm}\textit{en}\\ \hline
                    \toprule
            \end{longtabu}

            \begin{longtabu}to \textwidth {X[1.2,r] X[6,m] X[6,m] X[6,m]}
                \toprule
                & \textbf{sprechen} \textit{falar} & \textbf{lernen} \textit{aprender} & \\ \tabucline-
                    ich & \textsb{sprech}\textit{e} & \textsb{lern}\textit{e} & \\ \hline
                    du & \textit{sprichst} & \textsb{lern}\textit{st} & \\ \hline
                    er/sie & \textit{spricht} & \textsb{lern}\textit{t} & \\ \hline
                    Sie & \textsb{sprech}\textit{en} & \textsb{lern}\textit{en} & \\ \hline
                    \toprule
            \end{longtabu}
        ...
        \subsubsection{Irregular}
            ...
            \begin{longtabu}to \textwidth {X[1.2,r] X[6,m] X[6,m] X[6,m]}
                \toprule
                & \textbf{sein} \textit{ser} & & \\ \tabucline-
                    ich & \textit{bin} & & \\ \hline
                    du & \textit{bist} & & \\ \hline
                    er/sie & \textit{ist} & & \\ \hline
                    Sie & \textit{sind} & & \\ \hline
                    \toprule
            \end{longtabu}

    \subsection{Wortschatz}\label{subsection:deutsch:wortschatz}

        \phonetics{Wortschatz}{vóót-xátss}{vocabulário}
